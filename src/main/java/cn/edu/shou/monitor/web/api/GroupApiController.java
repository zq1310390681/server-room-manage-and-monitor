...
import cn.edu.shou.monitor.domain.MissivePublishFunction;
...
public class GroupApiController {
  ...
  /*  @Autowired
    ...
    public List<Group> getGroupByParentId(@RequestParam(value = "id",required = false)Long id){
        ...
        if (id==null){
            Group gp=groupDAO.findByGroupName("东海预报中心");
...
//       }
    ...
    public List<Group> updateGroup(@RequestParam long id,
                                   @RequestParam String groupName, @RequestParam String description)
    {
    ...
    public List<Group> createGroup(@RequestParam(value = "parentGroup")Long groupId, @RequestParam String groupName,
    ...
    @ResponseBody
    public String createUserFunc(@RequestParam(value = "groupId")Long groupId, @RequestParam String name,
                                 @RequestParam String userName, @RequestParam String password,
                                 @RequestParam String sex, @RequestParam String tel,
    ...
    public List<User> updateUser(@RequestParam(value = "groupId")Long groupId, @RequestParam long id,
