...
import cn.edu.shou.monitor.domain.user.UserCreateRequest.UserCreateParams;
...
import cn.edu.shou.monitor.domain.user.UserUpdateRequest.UserUpdateParams;
import cn.edu.shou.monitor.domain.user.UserUpdatemediaRequest;
import cn.edu.shou.monitor.service.zbxapi.IUserService;
...
//			}
	 ...
	 * @param get
	 * @return Object
	 * @see cn.edu.shou.monitor.service.zbxapi.IUserService#get(cn.edu.shou.monitor.domain.user.UserGetRequest)
	 */
	@Override
...
//		get.getParams().setSelectMediatypes("extend");
	 ...
	 * @param get
	 * @return
	 * @see cn.edu.shou.monitor.service.zbxapi.IUserService#getUserBean(cn.edu.shou.monitor.domain.user.UserGetRequest)
	 */
	@Override
	 ...
	 * @param login
	 * @return Object
	 * @see cn.edu.shou.monitor.service.zbxapi.IUserService#login(cn.edu.shou.monitor.domain.user.UserLoginRequest)
	 */
	@Override
...
//			System.out.println(rs);
	 ...
	 * @param logout
	 * @return Object
	 * @see cn.edu.shou.monitor.service.zbxapi.IUserService#logout(cn.edu.shou.monitor.domain.user.UserLogoutRequest)
	 */
	@Override
